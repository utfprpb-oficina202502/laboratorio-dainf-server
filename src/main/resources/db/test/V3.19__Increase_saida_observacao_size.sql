...
-- 3. Executar:
--    ALTER TABLE saida ALTER COLUMN observacao VARCHAR(255);
--    ALTER TABLE saida_aud ALTER COLUMN observacao VARCHAR(255);

ALTER TABLE saida ALTER COLUMN observacao VARCHAR(2000);

-- Também atualiza a tabela de auditoria correspondente
ALTER TABLE saida_aud ALTER COLUMN observacao VARCHAR(2000);
